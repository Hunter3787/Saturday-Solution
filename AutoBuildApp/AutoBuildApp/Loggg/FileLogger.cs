...
namespace AutoBuildApp.Loggg
{
    public class FileLogger : ILogger // Use ILogger interface.
    {
        ...
        public FileLogger(LoggingProvider provider) // Default constructor for this class. It should not be null. Also passing in an object from the LoggingProvider class as a parameter.
        {
            _provider = provider;
        }
