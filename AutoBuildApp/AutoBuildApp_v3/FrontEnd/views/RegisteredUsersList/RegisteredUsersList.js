const uri = 'http://http://ec2-13-52-186-63.us-west-1.compute.amazonaws.com:8081/usermanagement';
var users = [];
...
await fetch("http://http://ec2-13-52-186-63.us-west-1.compute.amazonaws.com:8081/usermanagement/lock", {
method: 'PUT',
mode: 'cors',
headers: {
'Accept': 'application/json',
...
async function savePermission(username, permission) {
    ...
    await fetch("http://http://ec2-13-52-186-63.us-west-1.compute.amazonaws.com:8081/usermanagement/permission", {
method: 'PUT',
mode: 'cors',
headers: {
'Accept': 'application/json',
...
async function deleteUser(username) {
  ...
  if(!result) {
    ...
    await fetch("http://http://ec2-13-52-186-63.us-west-1.compute.amazonaws.com:8081/usermanagement/user", {
method: 'DELETE',
mode: 'cors',
headers: {
'Accept': 'application/json',
