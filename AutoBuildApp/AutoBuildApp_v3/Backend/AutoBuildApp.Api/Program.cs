...
namespace AutoBuildApp.Api
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            //    };
            //    WebCrawlerService wcs = new WebCrawlerService(ConnectionManager.connectionManager.GetConnectionStringByName(ControllerGlobals.LOCALHOST_CONNECTION));
            ...
            #region Nick Specific Crawler run
            //new Thread(() =>
            //{
            //    //AsyncContext.Run(async () => await new BrowserFetcher().DownloadAsync(BrowserFetcher.DefaultRevision));
            //    List<string> newEggBlackList = new List<string>();
            ...
            //        new StartingLink("https://www.newegg.com/Computer-Cases/SubCategory/ID-7/Page-1?Tid=7583", ProductType.Case.ToString()),
            //        new StartingLink("https://www.newegg.com/Power-Supplies/SubCategory/ID-58/Page-1?Tid=7657", ProductType.PSU.ToString()),
            //        new StartingLink("https://www.newegg.com/Desktop-Memory/SubCategory/ID-147/Page-1?Tid=7611", ProductType.RAM.ToString()),
