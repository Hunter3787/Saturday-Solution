...
DROP TABLE IF EXISTS Product_relations_Table;
...
(productID) REFERENCES Products(productID)
 ...
 -- requires a hard drive, case, motherboard, psu, graphics card, processor, ram, cooler
 --  kk based off of budget -> (spits out a score per component)

 CREATE TABLE Product_relations_Table(

 productID BIGINT NOT NULL,
 productIDCompatible BIGINT NOT NULL,
CONSTRAINT Product_relations_PK PRIMARY KEY (productIDCompatible),
CONSTRAINT	products_Relations_FK2 FOREIGN KEY
(productID) REFERENCES Products(productID),
CONSTRAINT	products_Relations_FK1 FOREIGN KEY
(productIDCompatible) REFERENCES Products(productID));



--CREATE TYPE BUILDCOMPONENTS AS TABLE
--(
--product1 
...
--CREATE FUNCTION GETCOMPONENTSPERBUDGET(
--@BUDGET FLOAT)
--BEGIN
--RETURN
--SELECT * 
--	FROM Products products 
--	INNER JOIN Vendor_Product_Junction
--	productByVendor 
--	on productByVendor.productID = products.productID;
--END
