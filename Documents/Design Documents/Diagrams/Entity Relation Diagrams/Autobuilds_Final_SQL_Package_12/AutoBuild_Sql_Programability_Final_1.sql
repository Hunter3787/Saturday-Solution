			...
			BEGIN
				IF @USERHASHID IS NOT NULL
					...
					INSERT INTO Logs
						...
						VALUES (@MESSAGE, @EVENTTYPE, @EVENTVALUE, @DATETIME, @USERHASHID)
				...
				ELSE --(JUST INSERT INTO USER SESSIONS WITH USERID -> NULL)
					BEGIN
						...
						INSERT INTO Logs
						(message, loglevel, eventType, eventValue, creationDate, userHashID)
						VALUES (@MESSAGE, @EVENTTYPE, @EVENTVALUE, @DATETIME, null)
					END
			END
END
GO
 ...
 -- THE CLAIMS TYPE USED BY RegisterAccount PROCEDURE
	...
	-- testing this: 
		GO
				...
				INSERT INTO @INDEXES  VALUES ( 2, 5);
				INSERT INTO @INDEXES  VALUES ( 1, 3);
				INSERT INTO @INDEXES  VALUES ( 5, 4);
				INSERT INTO @INDEXES  VALUES ( 4, 1);
				INSERT INTO @INDEXES  VALUES ( 3, 2);
